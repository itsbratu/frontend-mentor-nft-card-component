    ...
    return(
        <div className='relative inset-x-card-x inset-y-card-y w-card-width h-card-height bg-neutral-card-bg rounded-3xl'>
            <div className='flex flex-col relative inset-info w-info-width h-info-height'>
                <img src='/images/image-equilibrium.jpg' className='h-image-height rounded-2xl '/>
                <div className='pl-1 mt-5 flex flex-col justify-between w-full h-subinfo-height select-none'>
                    <h1 className='font-main-font font-extrabold text-neutral-white animation ease-in-out hover:text-primary-cyan hover:cursor-pointer text-2xl tracking-wide h-1/6'>Equilibrum #3429</h1>
                    <p className='font-main-font text-primary-soft-blue font-medium-400 opacity-95 text-xl h-1/4'>Our Equilibrum collection promotes balance and calm.</p>
                    <div className='flex justify-between h-1/5'>
                        <div className='flex w-value-section-width font-main-font items-center'>
                            ...
                            <h2 className='font-main-font font-bold-600 text-lg text-primary-cyan w-5/6 pl-2'>0.041 ETH</h2>
                        </div>
